...
export const INSIGHTS: Insight[] = [
  ...
  {
    id: 'protein-tef',
    text: 'Protein has the highest "thermic effect" — you burn 20–30% of its calories just digesting it, vs 5–10% for carbs and 0–3% for fat.',
    source: 'Westerterp, Nutr Metab 2004',
    anchor: 'advanced',
  },
  {
    id: 'bmr-share',
    text: 'Your resting metabolism is usually 60–70% of everything you burn — the biggest and most stable slice of your day.',
  ...
  {
    id: 'underreporting',
    text: 'People underestimate how much they eat by 20–50% on average — even trained dietitians do it.',
  ...
  {
    id: 'safe-rate',
    text: 'A safe, sustainable fat-loss pace is about 0.5–1% of your bodyweight per week — faster usually means losing muscle and water too.',
  ...
  {
    id: 'protein-target',
    text: 'Aim for about 1.6–2.2 g of protein per kg of bodyweight to build or keep muscle — much more than that adds little for most people.',
